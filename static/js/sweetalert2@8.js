!function (t, e) {
    ...
    if (e && !b(e, x.hide)) {
      ...
      if (n) {
        ...
        at(e, x.show), rt(e, x.hide), function (t, e, n) {
          var o = H(), i = ft && j(e), r = n.onClose, a = n.onAfterClose;
  ...
  var $t = function (t, e, n, o) {
    Ht.swalCloseEventFinishedCallback = Zt.bind(null, t, n, ut(), o), e.addEventListener(ft, function (t) {
  ...
  function ie(t) {
    var e = H(), n = R();
    "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), me(e, n, t), fe(e, n), G() && pe(e, t.scrollbarPadding), ut() || Ht.previousActiveElement || (Ht.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function () {
      return t.onOpen(n)
    })
  }
  ...
  var fe = function (t, e) {
      ft && j(e) ? (t.style.overflowY = "hidden", e.addEventListener(ft, oe.bind(null, e, t))) : t.style.overflowY = "auto"
    }, pe = function (t, e) {
      !function () {
  ...
  }), Ue.DismissReason = k, Ue.version = "8.18.3";
  var Fe = Ue;
